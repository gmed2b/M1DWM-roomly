...
def test_create_booking_without_confirmation(mock_booking_class, mock_room_class, mock_db, booking_data_full_day):
    mock_room = MagicMock()
...
@patch('app.services.booking_service.Room')
@patch('app.services.booking_service.Booking')
def test_create_booking_with_confirmation(mock_booking_class, mock_room_class, mock_db, booking_data_half_day):
    mock_room = MagicMock()
...
def test_get_user_bookings(mock_booking_class, mock_format_booking):
    booking1 = MagicMock()
    booking2 = MagicMock()
    mock_booking_class.query.filter_by.return_value.all.return_value = [booking1, booking2]
