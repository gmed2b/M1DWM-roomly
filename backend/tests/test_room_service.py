...
class TestRoomService(unittest.TestCase):
    ...
    def test_get_all_rooms(self):
        ...
        with patch.object(self.RoomService, '_format_room_data', return_value={"name": "Salle Test"}):
    ...
    def test_create_room_integrity_error(self):
        ...
        self.mock_db.session.commit.side_effect = IntegrityError("Duplicate slug", None, None)
